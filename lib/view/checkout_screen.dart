...
class CheckoutScreenBackup extends StatefulWidget {
  final double amount;
  final String orderType;
  final List<CartModel> cartList;
  final bool fromCart;
  final String couponCode;
  CheckoutScreenBackup(
...
class _CheckoutScreenState extends State<CheckoutScreenBackup> {
                  ...
                  onTap: () {
                    ...
                    if (widget.amount <
                      ...
                      if (_isCashOnDeliveryActive &&
                        ...
                        final String _placeOrder = convert.base64Url.encode(
                            convert.utf8.encode(
                                convert.jsonEncode(_placeOrderBody.toJson())));
                        String _url =
                        ...
                        if (ResponsiveHelper.isWeb()) {
                          order.clearPlaceOrder().then((_) {
                            order.setPlaceOrder(_placeOrder).then((value) =>
