...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    Provider.of<OrderProvider>(context, listen: false)
        ...
        .whenComplete(() => Provider.of<TimerProvider>(context, listen: false)
            .countDownTimer(
                Provider.of<OrderProvider>(context, listen: false).trackModel,
                context));
  }
          ...
          children: [
            ConstrainedBox(
              constraints: BoxConstraints(
                  minHeight:
                      !ResponsiveHelper.isDesktop(context) && _height < 600
                          ? _height
                          : _height - 400),
              child: Padding(
                          ...
                          ? RefreshIndicator(
                              onRefresh: () async {
                                ...
                                await Provider.of<OrderProvider>(context,
                                        listen: false)
                                    .trackOrder(
                                        widget.orderID, null, context, true);
                              },
