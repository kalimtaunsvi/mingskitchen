  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          : CustomAppBar(
              context: context, title: getTranslated('order_details', context)),
                                              ...
                                              Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    order.trackModel
                                                        ...
                                                        : Text(
                                                            DateConverter
                                                                .isoStringToLocalDateOnly(order
                                                                    .trackModel
                                                                    .createdAt),
                                                            style: rubikRegular,
                                                          ),
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (ResponsiveHelper
                                                                          ...
                                                                          Navigator.pushReplacementNamed(
                                                                              context,
                                                                              Routes.getPaymentRoute(page: 'order', id: order.trackModel.id.toString(), user: order.trackModel.userId));
                                                                        }
                                                                      },
                                                                    ),
                                                                  ))
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: CustomButton(
                                                              ...
                                                              onTap: () {
                                                                Navigator.pushNamed(
                                                                    context,
                                                                    Routes.getOrderTrackingRoute(order
                                                                        .trackModel
                                                                        .id));
                                                              },
                                                            ),
                                                                      ...
                                                                      child: Row(
                                                                          children: [
                                                                            ...
                                                                            Text(PriceConverter.convertPrice(context, _addOns[i].price),
                                                                                style: rubikMedium),
                                                                            SizedBox(width: 2),
                                                                            Text('(${order.orderDetails[index].addOnQtys[i]})',
                                                                                style: rubikRegular),
                                                                          ]),
                                                                    );
                                                                  },
