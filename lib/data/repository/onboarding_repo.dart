    ...
    try {
      List<OnBoardingModel> onBoardingList = [
        OnBoardingModel(
            ...
            getTranslated('make_your_choice_order', context),
            getTranslated('you_can_choice_the_best', context)),
        OnBoardingModel(
            Images.onboarding_two,
            getTranslated('select_delivery_location', context),
            getTranslated('select_accurate_location', context)),
        OnBoardingModel(
            Images.onboarding_three,
            getTranslated('delivery_to_your_home', context),
            getTranslated('get_food_delivery_at_home', context)),
      ];
