...
import 'package:flutter_restaurant/view/screens/book_table/book_table.dart';
...
//*******Handlers*********
  ...
  static Handler _bookTableHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) => BookTableScreen());
...
//*******Route Define*********
  static void setupRouter() {
    ...
    router.define(Routes.POPULAR_ITEM_ROUTE,
        ...
        transitionType: TransitionType.fadeIn);
    router.define(Routes.BOOK_TABLE_SCREEN,
        handler: _bookTableHandler, transitionType: TransitionType.fadeIn);
  }
}
